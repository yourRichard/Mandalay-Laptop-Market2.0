...
// const Footer = () => {
//   return (
// <div className="px-4 pt-8 bg-slate-200 shadow-md mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
//   <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
//     <div className="sm:col-span-2">
//       <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
       
//         <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">Mandalay Laptop Market</span>
//       </a>
...
//         <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">+959444020221 </a>
//       </div>
//       <div className="flex">
